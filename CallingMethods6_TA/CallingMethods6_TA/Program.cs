...
namespace CallingMethods6_TA
{
    class Program
    {
        static void Main()
        {
            ...
            Employee<int> employee4 = new Employee<int>() { FirstName = "Joe", LastName = "Pupil", id = 023 };
            Employee<int> employee5 = new Employee<int>() { FirstName = "Joe", LastName = "Pupil", id = 024 };
